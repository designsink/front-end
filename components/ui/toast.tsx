...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-8 left-1/2 -translate-x-1/2 z-[100] flex flex-col items-center w-auto max-w-full p-0",
      className
    )}
    {...props}
  />
